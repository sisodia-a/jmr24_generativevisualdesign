...
class Visualizer():
    ...
    def reconstruct(self, data, size=(8, 8), is_original=True, is_force_return=False):
        ...
        with torch.no_grad():
            ...
            continuousprice = continuousprice.to(self.device)[:n_samples, ...]
            discreteprice = discreteprice.to(self.device)[:n_samples, ...]
            ...
            discreteprice_brand = discreteprice_brand.to(self.device)[:n_samples, ...]
            discreteprice_circa = discreteprice_circa.to(self.device)[:n_samples, ...]
            discreteprice_material = discreteprice_material.to(self.device)[:n_samples, ...]
            discreteprice_movement = discreteprice_movement.to(self.device)[:n_samples, ...]
            brand_circa = brand_circa.to(self.device)[:n_samples, ...]
            brand_material = brand_material.to(self.device)[:n_samples, ...]
            brand_movement = brand_movement.to(self.device)[:n_samples, ...]
            circa_material = circa_material.to(self.device)[:n_samples, ...]
            circa_movement = circa_movement.to(self.device)[:n_samples, ...]
            material_movement = material_movement.to(self.device)[:n_samples, ...]
            discreteprice_brand_circa = discreteprice_brand_circa.to(self.device)[:n_samples, ...]
            discreteprice_brand_material = discreteprice_brand_material.to(self.device)[:n_samples, ...]
            discreteprice_brand_movement = discreteprice_brand_movement.to(self.device)[:n_samples, ...]
            discreteprice_circa_material = discreteprice_circa_material.to(self.device)[:n_samples, ...]
            discreteprice_circa_movement = discreteprice_circa_movement.to(self.device)[:n_samples, ...]
            discreteprice_material_movement = discreteprice_material_movement.to(self.device)[:n_samples, ...]
            brand_circa_material = brand_circa_material.to(self.device)[:n_samples, ...]
            brand_circa_movement = brand_circa_movement.to(self.device)[:n_samples, ...]
            brand_material_movement = brand_material_movement.to(self.device)[:n_samples, ...]
            circa_material_movement = circa_material_movement.to(self.device)[:n_samples, ...]
            discreteprice_brand_circa_material = discreteprice_brand_circa_material.to(self.device)[:n_samples, ...]
            discreteprice_brand_circa_movement = discreteprice_brand_circa_movement.to(self.device)[:n_samples, ...]
            discreteprice_brand_material_movement = discreteprice_brand_material_movement.to(self.device)[:n_samples, ...]
            discreteprice_circa_material_movement = discreteprice_circa_material_movement.to(self.device)[:n_samples, ...]
            brand_circa_material_movement = brand_circa_material_movement.to(self.device)[:n_samples, ...]
            discreteprice_brand_circa_material_movement = discreteprice_brand_circa_material_movement.to(self.device)[:n_samples, ...]
            
            filenames = filenames.to(self.device)[:n_samples, ...]
            recs, _, _, _, _ = self.model(originals, signal_value, continuousprice, discreteprice, brand, circa, material, movement, discreteprice_brand, discreteprice_circa, discreteprice_material, discreteprice_movement, brand_circa, brand_material, brand_movement, circa_material, circa_movement, material_movement, discreteprice_brand_circa, discreteprice_brand_material, discreteprice_brand_movement, discreteprice_circa_material, discreteprice_circa_movement, discreteprice_material_movement, brand_circa_material, brand_circa_movement, brand_material_movement, circa_material_movement, discreteprice_brand_circa_material, discreteprice_brand_circa_movement, discreteprice_brand_material_movement, discreteprice_circa_material_movement, brand_circa_material_movement, discreteprice_brand_circa_material_movement, filenames)
